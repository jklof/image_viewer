...
class UniversalQueryBuilder(QWidget):
    ...
    def set_interactive_controls_enabled(self, enabled: bool):
        """
        Enables or disables only the user-interactive controls,
        leaving the main widget enabled to accept drops.
        """
